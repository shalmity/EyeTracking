Shader "Unlit/Texture_Heatmap"
{
  Properties
  {
    _MainTex("Texture", 2D) = "white" {}
    _Color0("Color 0",Color) = (0, 0, 0, 1)
      _Color1("Color 1",Color) = (0, 0.9, 0.2, 1)
      _Color2("Color 2",Color) = (0.9, 1, 0.3, 1)
      _Color3("Color 3",Color) = (0.9, 0.7, 0.1, 1)
    ...
    SubShader
    {
      ...
      Pass
      {
        ...
        float _Hits[3 * 200]; //passed in array of pointranges 3floats/point, x,y,intensity = 200회 클릭 가능 이후 초기화
        int _HitCount = 0;
